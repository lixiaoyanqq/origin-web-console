...
;angular.module('patternfly.notification').component('pfNotificationDrawer', {
  ...
  controller: ["$window", "$timeout", "$element", 'gettext', 'gettextCatalog', function ($window, $timeout, $element, gettext, gettextCatalog) {
    'use strict';
    var ctrl = this;
    ...
    var setupGroups = function () {
      ...
      angular.forEach(ctrl.notificationGroups, function (group) {
        group.emptyStateConfig = {
          icon: 'pficon-info',
          title: group.noNotificationsText || ctrl.noNotificationsText || gettextCatalog.getString(gettext("There are no notifications to display."))
        };
      });
    ...
    ctrl.$onInit = function () {
      ...
      ctrl.emptyStateConfig = {
        icon: 'pficon-info',
        title: ctrl.noNotificationsText || gettextCatalog.getString(gettext("There are no notifications to display."))
      };
