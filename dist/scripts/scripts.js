...
type: "info",
message: t.metadata.name + " " + o.getString(i("is paused")),
details: o.getString(i("This will stop any new rollouts or triggers from running until resumed.")),
links: [ {
href: "",
label: o.getString(i("Resume Rollouts")),
onClick: function() {
